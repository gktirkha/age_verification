...
class AgeVerificationApi {
  ...
  Future<AgeVerificationResult> verifyAge({List<int>? ageGates, bool skipEligibilityCheck = false}) async {
    ...
    final Future<Object?> pigeonVar_sendFuture = pigeonVar_channel.send(<Object?>[ageGates, skipEligibilityCheck]);
    final pigeonVar_replyList = await pigeonVar_sendFuture as List<Object?>?;
